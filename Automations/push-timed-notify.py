# THIS SCRIPT IS USED TO SYNCHRONIZE THE DATA FROM MY MAIN SERVER TO MY BACKUP SERVER EVERYDAY AT MIDNIGHT AND SENDS NOTIFICATIONS WHEN IT'S STARTING / DONE
